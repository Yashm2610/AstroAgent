...
export default function ChatWindow({ searchFilter }) {
  ...
  const handleScroll = () => {
    ...
    // Show button if user scrolled up more than 250px from bottom
    setShowScrollButton(scrollHeight - scrollTop - clientHeight > 250);
  };
  ...
  return (
    <div className="relative flex-1 flex flex-col min-h-0">
      <div 
        ...
        className="flex-1 overflow-y-auto px-4 py-6 space-y-4 min-h-[400px]"
      >
